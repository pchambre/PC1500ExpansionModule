...
#define EXP_INSTRUCTION_PAGE 0x0F //Command page for PC to submit requests
#define EXP_BUFFER_START_PAGE 0x0C //First page of the read/write data exchange area
