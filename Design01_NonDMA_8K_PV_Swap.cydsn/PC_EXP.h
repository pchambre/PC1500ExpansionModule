...
#define EXP_COMMAND_STORE_ERASE 0x32 //FNSAVE/STSAVE flash stores -- RP2350 only
...
#define EXP_KW_ACTION_COPY_IN 10
#define EXP_KW_ACTION_COPY_OUT 11
#define EXP_KW_ACTION_RESTORE 12
